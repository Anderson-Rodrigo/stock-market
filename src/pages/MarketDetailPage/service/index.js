...
export function findCompanyOverviewer(symbol, onSuccess, onError){
...
export function findEarnings(symbol, onSuccess, onError){
    api.get(`query?function=${APIFunctionType.EARNINGS}&symbol=${symbol}&apikey=${APIKey}findEarnings`)
        .then(response => {
            onSuccess && onSuccess(response.data)
        })
        .catch(error => {
